...
class USStocks(object):
    def __init__(self, config):
        ...
        self.all_available_symbols = list(self.us_large_cap_data_loader.list_symbols()).copy()
        self.all_available_symbols.extend(list(self.us_small_cap_data_loader.list_symbols()))
